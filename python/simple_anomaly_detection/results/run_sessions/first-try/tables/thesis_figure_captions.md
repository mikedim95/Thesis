...
- PNG: results\run_sessions\first-try\figures\thesis\benchmark_overview.png
- PDF: results\run_sessions\first-try\figures\thesis\benchmark_overview.pdf

Benchmark overview across 91 benchmarked datasets and 40 algorithm configurations. The top row summarizes dataset coverage in series length and anomaly ratio. The bottom-left panel shows the runtime versus Mean Range F1 tradeoff with the Pareto frontier, and the bottom-right panel compares mean Range F1 and mean ROC AUC across configurations. In this run, the strongest average configuration was SAND | Subseq x2 with mean Range F1 0.303 and mean ROC AUC 0.932.

## pareto_frontier
- Title: Pareto frontier
- PNG: results\run_sessions\first-try\figures\thesis\pareto_frontier.png
- PDF: results\run_sessions\first-try\figures\thesis\pareto_frontier.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\metric_heatmap.png
- PDF: results\run_sessions\first-try\figures\thesis\metric_heatmap.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\family_evaluation_heatmap.png
- PDF: results\run_sessions\first-try\figures\thesis\family_evaluation_heatmap.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\algorithm_wins.png
- PDF: results\run_sessions\first-try\figures\thesis\algorithm_wins.pdf

Per-dataset win counts for the two most defensible leaderboard views in this notebook: best Range F1 and best ROC AUC. Matrix Profile | Subseq x4 won the most datasets by Range F1 with 10 wins.

## ablation_overview
- Title: Global one-factor-at-a-time ablation overview
- PNG: results\run_sessions\first-try\figures\thesis\ablation_overview.png
- PDF: results\run_sessions\first-try\figures\thesis\ablation_overview.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\isolation_forest_paper_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\isolation_forest_paper_panel.pdf

Paper panel for Isolation Forest. The three heatmaps summarize mean Range F1 by dataset variant, series length, and anomaly-ratio regime, while the runtime scatter shows which configured variants convert extra cost into measurable gains. In this run, the strongest Isolation Forest variant was Isolation Forest | Trees 400 with mean Range F1 0.153 and mean ROC AUC 0.720.

## isolation_forest_ablation_panel
- Title: Isolation Forest ablation panel
- PNG: results\run_sessions\first-try\figures\thesis\isolation_forest_ablation_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\isolation_forest_ablation_panel.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\isolation_forest_variant_comparison_141_ucr_anomaly_internalbleeding5_4000_6200_6370.png
- PDF: results\run_sessions\first-try\figures\thesis\isolation_forest_variant_comparison_141_ucr_anomaly_internalbleeding5_4000_6200_6370.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\isolation_forest_showcase_054_ucr_anomaly_distortedwalkingaceleration5_2700_5920_5979.png
- PDF: results\run_sessions\first-try\figures\thesis\isolation_forest_showcase_054_ucr_anomaly_distortedwalkingaceleration5_2700_5920_5979.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\local_outlier_factor_paper_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\local_outlier_factor_paper_panel.pdf

Paper panel for Local Outlier Factor. The three heatmaps summarize mean Range F1 by dataset variant, series length, and anomaly-ratio regime, while the runtime scatter shows which configured variants convert extra cost into measurable gains. In this run, the strongest Local Outlier Factor variant was Local Outlier Factor | Leaf size 60 with mean Range F1 0.161 and mean ROC AUC 0.829.

## local_outlier_factor_ablation_panel
- Title: Local Outlier Factor ablation panel
- PNG: results\run_sessions\first-try\figures\thesis\local_outlier_factor_ablation_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\local_outlier_factor_ablation_panel.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\local_outlier_factor_variant_comparison_137_ucr_anomaly_internalbleeding18_2300_4485_4587.png
- PDF: results\run_sessions\first-try\figures\thesis\local_outlier_factor_variant_comparison_137_ucr_anomaly_internalbleeding18_2300_4485_4587.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\local_outlier_factor_showcase_137_ucr_anomaly_internalbleeding18_2300_4485_4587.png
- PDF: results\run_sessions\first-try\figures\thesis\local_outlier_factor_showcase_137_ucr_anomaly_internalbleeding18_2300_4485_4587.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\sand_paper_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\sand_paper_panel.pdf

Paper panel for SAND. The three heatmaps summarize mean Range F1 by dataset variant, series length, and anomaly-ratio regime, while the runtime scatter shows which configured variants convert extra cost into measurable gains. In this run, the strongest SAND variant was SAND | Subseq x2 with mean Range F1 0.303 and mean ROC AUC 0.932.

## sand_ablation_panel
- Title: SAND ablation panel
- PNG: results\run_sessions\first-try\figures\thesis\sand_ablation_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\sand_ablation_panel.pdf

One-factor-at-a-time ablation panel for SAND. Horizontal bars report paired deltas against the algorithm baseline, error bars show bootstrap 95% confidence intervals, the runtime scatter isolates cost, and the heatmap shows regime sensitivity by dataset variant. The strongest positive ablation for SAND in this run was Subseq x2 with mean Range F1 delta +0.013.

## sand_variant_comparison
- Title: SAND side-by-side variant comparison
- PNG: results\run_sessions\first-try\figures\thesis\sand_variant_comparison_054_ucr_anomaly_distortedwalkingaceleration5_2700_5920_5979.png
- PDF: results\run_sessions\first-try\figures\thesis\sand_variant_comparison_054_ucr_anomaly_distortedwalkingaceleration5_2700_5920_5979.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\sand_showcase_130_ucr_anomaly_gp711markerlfm5z4_4000_6527_6645.png
- PDF: results\run_sessions\first-try\figures\thesis\sand_showcase_130_ucr_anomaly_gp711markerlfm5z4_4000_6527_6645.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\matrix_profile_paper_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\matrix_profile_paper_panel.pdf

Paper panel for Matrix Profile. The three heatmaps summarize mean Range F1 by dataset variant, series length, and anomaly-ratio regime, while the runtime scatter shows which configured variants convert extra cost into measurable gains. In this run, the strongest Matrix Profile variant was Matrix Profile | Subseq x1 with mean Range F1 0.275 and mean ROC AUC 0.930.

## matrix_profile_ablation_panel
- Title: Matrix Profile ablation panel
- PNG: results\run_sessions\first-try\figures\thesis\matrix_profile_ablation_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\matrix_profile_ablation_panel.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\matrix_profile_variant_comparison_143_ucr_anomaly_internalbleeding8_2500_5865_5974.png
- PDF: results\run_sessions\first-try\figures\thesis\matrix_profile_variant_comparison_143_ucr_anomaly_internalbleeding8_2500_5865_5974.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\matrix_profile_showcase_031_ucr_anomaly_distortedinternalbleeding20_2700_5759_5919.png
- PDF: results\run_sessions\first-try\figures\thesis\matrix_profile_showcase_031_ucr_anomaly_distortedinternalbleeding20_2700_5759_5919.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\damp_paper_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\damp_paper_panel.pdf

Paper panel for DAMP. The three heatmaps summarize mean Range F1 by dataset variant, series length, and anomaly-ratio regime, while the runtime scatter shows which configured variants convert extra cost into measurable gains. In this run, the strongest DAMP variant was DAMP | x_lag x8 with mean Range F1 0.198 and mean ROC AUC 0.867.

## damp_ablation_panel
- Title: DAMP ablation panel
- PNG: results\run_sessions\first-try\figures\thesis\damp_ablation_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\damp_ablation_panel.pdf

One-factor-at-a-time ablation panel for DAMP. Horizontal bars report paired deltas against the algorithm baseline, error bars show bootstrap 95% confidence intervals, the runtime scatter isolates cost, and the heatmap shows regime sensitivity by dataset variant. The strongest positive ablation for DAMP in this run was x_lag x8 with mean Range F1 delta +0.004.

## damp_variant_comparison
- Title: DAMP side-by-side variant comparison
- PNG: results\run_sessions\first-try\figures\thesis\damp_variant_comparison_173_ucr_anomaly_insectepg1_3000_7000_7030.png
- PDF: results\run_sessions\first-try\figures\thesis\damp_variant_comparison_173_ucr_anomaly_insectepg1_3000_7000_7030.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\damp_showcase_031_ucr_anomaly_distortedinternalbleeding20_2700_5759_5919.png
- PDF: results\run_sessions\first-try\figures\thesis\damp_showcase_031_ucr_anomaly_distortedinternalbleeding20_2700_5759_5919.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\hbos_paper_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\hbos_paper_panel.pdf

Paper panel for HBOS. The three heatmaps summarize mean Range F1 by dataset variant, series length, and anomaly-ratio regime, while the runtime scatter shows which configured variants convert extra cost into measurable gains. In this run, the strongest HBOS variant was HBOS | Bins 20 with mean Range F1 0.100 and mean ROC AUC 0.592.

## hbos_ablation_panel
- Title: HBOS ablation panel
- PNG: results\run_sessions\first-try\figures\thesis\hbos_ablation_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\hbos_ablation_panel.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\hbos_variant_comparison_133_ucr_anomaly_internalbleeding14_2800_5607_5634.png
- PDF: results\run_sessions\first-try\figures\thesis\hbos_variant_comparison_133_ucr_anomaly_internalbleeding14_2800_5607_5634.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\hbos_showcase_162_ucr_anomaly_walkingaceleration5_2700_5920_5979.png
- PDF: results\run_sessions\first-try\figures\thesis\hbos_showcase_162_ucr_anomaly_walkingaceleration5_2700_5920_5979.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\ocsvm_paper_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\ocsvm_paper_panel.pdf

Paper panel for OCSVM. The three heatmaps summarize mean Range F1 by dataset variant, series length, and anomaly-ratio regime, while the runtime scatter shows which configured variants convert extra cost into measurable gains. In this run, the strongest OCSVM variant was OCSVM | Gamma 0.1 with mean Range F1 0.241 and mean ROC AUC 0.721.

## ocsvm_ablation_panel
- Title: OCSVM ablation panel
- PNG: results\run_sessions\first-try\figures\thesis\ocsvm_ablation_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\ocsvm_ablation_panel.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\ocsvm_variant_comparison_139_ucr_anomaly_internalbleeding20_2700_5759_5919.png
- PDF: results\run_sessions\first-try\figures\thesis\ocsvm_variant_comparison_139_ucr_anomaly_internalbleeding20_2700_5759_5919.pdf

Side-by-side comparison of 5 OCSVM variants on the shared dataset 139_UCR_Anomaly_InternalBleeding20_2700_5759_5919. The top two panels show the raw and normalized signal with the ground-truth anomaly, and the lower panels compare per-variant score traces and threshold crossings on exactly the same time range.

## ocsvm_showcase
- Title: OCSVM showcase deep dive
- PNG: results\run_sessions\first-try\figures\thesis\ocsvm_showcase_130_ucr_anomaly_gp711markerlfm5z4_4000_6527_6645.png
- PDF: results\run_sessions\first-try\figures\thesis\ocsvm_showcase_130_ucr_anomaly_gp711markerlfm5z4_4000_6527_6645.pdf

Showcase deep dive for OCSVM on 130_UCR_Anomaly_GP711MarkerLFM5z4_4000_6527_6645. The panels align the raw signal, normalized signal, and anomaly score for the strongest selected variant on that dataset, making it possible to show exactly where the detector crosses threshold relative to the ground-truth anomaly interval. The selected showcase variant was OCSVM | Gamma 0.1 with Range F1 0.642, ROC AUC 0.993, and runtime 0.337s.

## pca_paper_panel
- Title: PCA paper panel
- PNG: results\run_sessions\first-try\figures\thesis\pca_paper_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\pca_paper_panel.pdf

Paper panel for PCA. The three heatmaps summarize mean Range F1 by dataset variant, series length, and anomaly-ratio regime, while the runtime scatter shows which configured variants convert extra cost into measurable gains. In this run, the strongest PCA variant was PCA | Weighted off with mean Range F1 0.103 and mean ROC AUC 0.571.

## pca_ablation_panel
- Title: PCA ablation panel
- PNG: results\run_sessions\first-try\figures\thesis\pca_ablation_panel.png
- PDF: results\run_sessions\first-try\figures\thesis\pca_ablation_panel.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\pca_variant_comparison_175_ucr_anomaly_insectepg3_5200_7000_7050.png
- PDF: results\run_sessions\first-try\figures\thesis\pca_variant_comparison_175_ucr_anomaly_insectepg3_5200_7000_7050.pdf
...
- PNG: results\run_sessions\first-try\figures\thesis\pca_showcase_131_ucr_anomaly_gp711markerlfm5z5_5000_8612_8716.png
- PDF: results\run_sessions\first-try\figures\thesis\pca_showcase_131_ucr_anomaly_gp711markerlfm5z5_5000_8612_8716.pdf
