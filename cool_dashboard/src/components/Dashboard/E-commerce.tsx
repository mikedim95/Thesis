  ...
  return (
    <>
      <div className="flex flex-wrap justify-between gap-4 md:gap-6">
        <div className="min-w-[100px] flex-1 transition-all duration-500 ease-in-out hover:flex-[3_1_0%] md:min-w-[350px] xl:min-w-[450px]">
          <CardDataStats
            title="Total views"
            total="$3.456K"
            rate="0.43%"
        ...
        <div className="min-w-[250px] flex-1 transition-all duration-300 ease-in-out hover:flex-[3_1_0%] md:min-w-[350px] xl:min-w-[450px]">
          <CardDataStats
            title="Total Profit"
            total="$45,2K"
            rate="4.35%"
      ...
      <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
        <ChartOne />
        <button onClick={handleClick("agent1", "test2Group")}>get event</button>
        <ChartThree />
        <MapOne />
